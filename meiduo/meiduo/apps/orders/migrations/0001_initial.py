# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2019-02-17 08:38
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('users', '0003_auto_20190127_2046'),
        ('goods', '0002_auto_20190130_1825'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='更新是时间')),
                ('count', models.IntegerField(default=1, verbose_name='数量')),
                ('price', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='单价')),
                ('comment', models.TextField(default='', verbose_name='评价信息')),
                ('score', models.SmallIntegerField(
                    choices=[(0, '0分'), (1, '20分'), (2, '40分'), (3, '60分'), (4, '80分'), (5, '100分')], default=5,
                    verbose_name='满意度评分')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_method',
                 models.SmallIntegerField(choices=[(1, '货到付款'), (2, '支付宝')], default=1, verbose_name='支付方式')),
                ('status', models.SmallIntegerField(
                    choices=[(1, '待支付'), (2, '待发货'), (3, '待收货'), (4, '待评价'), (5, '已完成'), (6, '已取消')], default=1,
                    verbose_name='订单状态')),
        ...
        migrations.AddField(
            ...
            name='order',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='skus',
                                    to='orders.OrderInfo', verbose_name='订单'),
        ),
        migrations.AddField(
            model_name='ordergoods',
            name='sku',
